...
Q2:
Predictions: Argument 1: The model template html displayed on the server; Argument 2: The title/name displayed of the server/tab; Argument 3: Takes in data to be applied
Results: Argument 1: The model template taken in as an input with Jinja templating; Argument 2: It replaces the variable foo with fooooo in the template (which changes the Title name); Argument 3: It replaces the colletion variable with the list coll and runs through it with a for loop in the HTML template
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Observations:
...
def test_tmplt():
    ...
    #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    return render_template( 'model_tmplt.html', collection=coll, foo = "fooooo") # Returns a HTML with the variables filled in
